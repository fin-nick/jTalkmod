...
package uk.ac.napier.javax.security.sasl;

import uk.ac.napier.javax.security.auth.callback.CallbackHandler;
...
<a href="{@docRoot}/../technotes/guides/security/crypto/CryptoSpec.html#Provider">JCA Security Provider Framework</a>,
    ...
    public static SaslServer
        createSaslServer(String mechanism,
                    ...
                    String serverName,
                    Map<String,?> props,
                    uk.ac.napier.javax.security.auth.callback.CallbackHandler cbh)
        throws SaslException {
