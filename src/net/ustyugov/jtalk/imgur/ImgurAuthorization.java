...
public class ImgurAuthorization {
    ...
    private ImgurAuthorization(Activity activity) {
        this.activity = activity;
    }

    public static ImgurAuthorization getInstance(Activity activity) {
        if (INSTANCE == null)
            INSTANCE = new ImgurAuthorization(activity);
        return INSTANCE;
    }

    public boolean isLoggedIn() {
        SharedPreferences prefs = activity.getSharedPreferences(SHARED_PREFERENCES_NAME, 0);
