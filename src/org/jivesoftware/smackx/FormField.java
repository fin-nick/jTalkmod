...
public class FormField {
    ...
    private final List<MediaElement> medias = new ArrayList<MediaElement>();
    ...
    public Iterator<MediaElement> getMedia() {
        synchronized (options) {
            return Collections.unmodifiableList(new ArrayList<MediaElement>(medias)).iterator();
        }
    }
    ...
    public String toXML() {
        ...
        for (Iterator<MediaElement> i = getMedia(); i.hasNext();) {
            buf.append((i.next()).toXML());
        }
