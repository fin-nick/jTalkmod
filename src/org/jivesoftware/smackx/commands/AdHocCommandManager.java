...
public class AdHocCommandManager {
     ...
     */
    private static Map<Connection, AdHocCommandManager> instances = new HashMap<Connection, AdHocCommandManager>();
    ...
    public static AdHocCommandManager getAddHocCommandsManager(Connection connection) {
        synchronized (instances) {
        	AdHocCommandManager adHocManager = instances.get(connection);
        	if (adHocManager != null) return adHocManager;
        	return new AdHocCommandManager(connection);
        }
    }
